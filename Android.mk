...
LOCAL_LDLIBS += -llog
<<<<<<< Updated upstream
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"hitscore"' -DVERSION='"1.1.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
LOCAL_CPPFLAGS += -std=c++2a
=======
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"hitscorevisualizer"' -DVERSION='"2.0.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include' -O3
