...
Compress-Archive -Path "./libs/arm64-v8a/libhitscore.so", "./Cover.jpg", "./libs/arm64-v8a/libbeatsaber-hook_2_2_5.so", "./mod.json" -DestinationPath $TempArchiveName -Force
